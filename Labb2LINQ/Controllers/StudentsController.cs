...
namespace Labb2LINQ.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            var schoolDbContext = _context.Students.Include(s => s.Classes);
        ...
        public async Task<IActionResult> Create([Bind("StudentId,FirstMidName,LastName,FK_ClassId")] Student student)
        {
            ...
            ViewData["FK_ClassId"] = new SelectList(_context.Classes, "ClassId", "ClassName", student.FK_ClassId);
            return View(student);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,FirstMidName,LastName,FK_ClassId")] Student student)
        {
