...
namespace Labb2LINQ.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TeacherId,FirstMidName,LastName")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TeacherId,FirstMidName,LastName")] Teacher teacher)
        {
